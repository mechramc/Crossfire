...
- [~] T-0615 Record baseline perplexity runs (wikitext-2-raw-v1, 20 chunks, c=512). Subtasks split by node below. Mac side DONE Session 25; PC side DONE Session 23. Cross-node finding: **Gemma 4 31B PPL differs dramatically by quant** — PC Config-I (TQ4_1S/Q4_K/Q8_0 mixed, 19 GB) reports PPL 2595, Mac Q8_0 (33 GB) reports PPL 11896. Not expected — Q8_0 normally bounds Config-I from below (higher quality = lower PPL). Either the two harnesses parse wikitext differently, the binaries compute logprobs differently, or a real quant-mode interaction on Gemma 4. Worth investigating before the C0 row locks in.
